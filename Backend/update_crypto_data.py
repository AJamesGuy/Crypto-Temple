...
from app.services.coingecko_service import get_top_cryptos, update_crypto_data
...
def main():
    ...
    with app.app_context():
        try:
            ...
            # Fetch top 200 cryptocurrencies (2 pages of 100)
            result = get_top_cryptos(limit=200, vs_currency='usd')
